...
import com.tuya.iot.server.core.constant.CaptchaType;
...
public class UserServiceImpl implements UserService {
     ...
     */
    @Override
    public com.tuya.iot.server.core.model.UserToken login(String spaceId, String userName, String password) {
        ...
        com.tuya.iot.server.core.model.UserToken userToken =
                new com.tuya.iot.server.core.model.UserToken(loginToken.getUid(), userName, null, roles.stream().map(e -> e.getRoleCode()).collect(Collectors.toList()));
        return userToken;
    }
