...
import com.tuya.iot.server.web.model.request.user.*;
import com.tuya.iot.server.ability.idaas.model.PermissionTypeEnum;
import com.tuya.iot.server.ability.user.model.MobileCountries;
import com.tuya.iot.server.ability.user.model.UserBaseInfo;
...
import com.tuya.iot.server.web.model.response.role.RoleDto;
import com.tuya.iot.server.web.model.response.user.UserDto;
    ...
    public Response<Boolean> createUser(@RequestBody UserAddReq req) {
        ...
        if (!StringUtils.isEmpty(req.getCountryCode())) {
            ...
            if (!LibPhoneNumberUtil.doValid(req.getUserName(), req.getCountryCode())) {
                ...
                return ResponseI18n.buildFailure(TELEPHONE_FORMAT_ERROR);
            }
        }
