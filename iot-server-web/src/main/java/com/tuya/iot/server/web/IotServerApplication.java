package com.tuya.iot.server.web;
...
@SpringBootApplication(scanBasePackages = "com.tuya.iot.server")
@ConnectorScan(basePackages = {"com.tuya.iot.server.ability.*.connector"})
